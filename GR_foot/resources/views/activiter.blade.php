            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
                ...
                <div class="activity-card {{ strtolower($terrain->type) }} group bg-white rounded-3xl shadow-xl overflow-hidden transform hover:-translate-y-3 hover:shadow-2xl transition-all duration-300">
                    <div class="relative overflow-hidden">
                        <div class="absolute top-4 right-4 z-10 bg-black bg-opacity-75 text-white px-3 py-1 rounded-full text-sm shadow-md">
                            {{ $terrain->tarif }} DH/h
                        </div>
                        @if($terrain->image)
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-6">{{ $terrain->description ?? 'Terrain de qualité pour vos activités sportives.' }}</p>
