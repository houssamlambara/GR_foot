    ...
    <footer class="bg-black py-10">
        <div class="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
            ...
            <div class="text-center md:text-left"> <!-- Ajout de text-center pour mobile -->
                ...
                <p class="text-gray-300 text-sm leading-relaxed">123 Avenue des Champs-Élysées, 75008 Paris,
                    France.</p>
            ...
            <div class="text-center md:text-left"> <!-- Ajout de text-center pour mobile -->
                ...
                <p class="text-gray-300 text-sm leading-relaxed">Des questions ? Nous sommes là pour vous aider.
                </p>
